 ...
 * бројот на јазли во листата N, а во вториот ред се дадени броевите. На излез треба да се
...
public class PalindromeDLL {
    ...
    public static int daliPalindrom(DLL<Integer> lista){
        int flag = 1;
        DLLNode<Integer> jazol1 = lista.getFirst();
        DLLNode<Integer> jazol2 = lista.getLast();
        while(jazol1.succ != null && jazol2.pred != null){
    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int i=0;i<n;i++){
            lista.insertLast(Integer.parseInt(delovi[i]));
        }

        System.out.println(daliPalindrom(lista));
