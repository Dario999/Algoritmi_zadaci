...
public class card_trick {
    ...
    public static int solve(int n){
        ...
        LinkedQueue<Integer> spil = new LinkedQueue();
        LinkedStack<Integer> kupce = new LinkedStack();
        ...
        while(true){
            if(spil.peek().equals(n))
                return counter;

            for(int i=0;i<7;i++)
                kupce.push(spil.dequeue());

            for(int i=0;i<7;i++){
                spil.enqueue(kupce.pop());
